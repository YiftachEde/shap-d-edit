...
def main():
    ...
    parser.add_argument("output_dir", type=str, default="./output", help="The directory to save the output files.")
    args = parser.parse_args()
    files = json.load(open(args.input_json))
    for _, file in tqdm(files.items()):
        output_folder = process_model(file['path'], args.output_dir)
        image_sequence = []
